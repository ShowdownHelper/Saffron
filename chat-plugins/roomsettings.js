...
exports.commands = {
	...
	modchat: function (target, room, user) {
		...
		} else if (room.modchat === 'trusted') {
			this.add("|raw|<div class=\"broadcast-red\"><b>Moderated chat was set to Trusted!</b><br />Only users with trusted accounts may talk. (Use `/untrusted` for more info).</div>");
		} else {
	...
	modchathelp: ["/modchat [off/trusted/+/%/@/*/#/&/~] - Set the level of moderated chat. Requires: *, @ for off/autoconfirmed/+ options, # & ~ for all the options"],
